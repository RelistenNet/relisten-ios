...
class RecentlyPlayedTabViewController: NewShowListRealmViewController<RecentlyPlayedTrack>, UIViewControllerRestoration {
    public required init() {
        super.init(query: MyLibrary.shared.recent.shows, providedArtist: nil, enableSearch: false)
    ...
    public required init(query: Results<RecentlyPlayedTrack>, providedArtist artist: ArtistWithCounts?, enableSearch: Bool) {
